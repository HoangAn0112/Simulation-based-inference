...
# Dictionary with the parameter ranges in lorgarithm
ode_parameter_log_ranges_dict = {"v_max_AckA":(3,7),
                              "v_max_Pta":(3,7),
                              "v_max_glycolysis":(3,7),
                              "Ki_ACE_glycolysis":(-1,3), 
                              "Km_ACCOA_TCA_cycle":(-1,3), 
                              "v_max_TCA_cycle":(3,8), 
                              "Ki_ACE_TCA_cycle":(-1,3), 
                              "Y":(-5,-3), 
                              "v_max_acetate_exchange":(3,8), 
                              "Km_ACE_acetate_exchange":(-1,3)
                              }
